...
public class Main {
	public static void main(String[] args) throws Exception {
        get_cal_from_url("https://www.google.com/calendar/ical/appirio.com_bhga3musitat85mhdrng9035jg%40group.calendar.google.com/public/basic.ics", "topcoder.ics");
        get_cal_from_url("https://www.google.com/calendar/ical/br1o1n70iqgrrbc875vcehacjg%40group.calendar.google.com/public/basic.ics", "codeforces.ics");

        filter_by_name("^[\\s\\S]*SRM[\\s\\S]*$", "topcoder.ics", "srms.ics");
        filter_by_name("^[\\s\\S]*Div\\. 1[\\s\\S]*$", "codeforces.ics", "cf_div1.ics");

        merge_cals("srms.ics", "cf_div1.ics", "srms&cf_div1.ics");
